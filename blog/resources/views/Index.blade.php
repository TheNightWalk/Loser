            ...
            <section id="sliderBox" class="hotimg">
        		<ul class="slides" style="width: 600%; transition-duration: 0.4s; transform: translate3d(-828px, 0px, 0px);">
        			...
        			<li style="width: 414px; float: left; display: block;" class="flex-active-slide">
        				<a href="{{url('shopcontent')}}"><img src="https://img.1yyg.net/Poster/20170605084728556.jpg" alt="">
        				</a>
        			</li>
        			<li style="width: 414px; float: left; display: block;" class="">
        				<a href="{{url('shopcontent')}}"><img src="https://img.1yyg.net/Poster/20170518163741543.jpg" alt=""></a>
        			</li>
        			<li style="width: 414px; float: left; display: block;" class="">
        				<a href="{{url('shopcontent')}}">
        					<img src="https://img.1yyg.net/Poster/20170227170302909.png" alt="">
        ...
        <div class="index-menu thin-bor-top thin-bor-bottom">
            <ul class="menu-list">
				@foreach($category_name as $k=>$v)
						<li>
							<a href="{{url('allshops?category_id=')}}{{$v->cate_id}}" id="btnAllGoods">
								<i class="fenlei"></i>
        	...
        	<ul class="right-con">
				<li>
					<span style="color: #4E555E;">
						<a href="./index.php" style="color: #4E555E;">恭喜<span class="username">啊啊啊</span>获得了<span>iphone7 红色 128G 闪耀你的眼</span></a>
					</span>
				</li>
				<li>
					<span style="color: #4E555E;">
				...
				@foreach($goods_hot as $v)
					<li style="border-right:1px solid #e4e4e4; ">
						<a href="{{url('shopcontent\\')}}{{$v->goods_id}}">
							...
							<img src="{{url('\goodsLogo\\')}}{{$v->goods_img}}" alt="图片加载中">
						</a>
					</li>
				@endforeach
			</ul>
			...
			@foreach($goods_data as $v)
            	<li id="23558" codeid="12751965" goodsid="23558" codeperiod="28436">
            		<a href="{{url('shopcontent\\')}}{{$v->goods_id}}" class="g-pic">
            			<img class="lazy" name="goodsImg" data-original="{{url('goodsLogo\\')}}{{$v->goods_img}}" width="136" height="136">
            		</a>
            		<p class="g-name">(第<em>{{$v->goods_id}}</em>潮){{$v->goods_desc}}</p>
            		...
            		<div class="btn-wrap" name="buyBox" limitbuy="0" surplus="58" totalnum="1625" alreadybuy="1567">
            			...
            			<div class="gRate" codeid="12751965" canbuy="58">
            				<a href="{{url('shopcontent\\')}}{{$v->goods_id}}"></a>
            			</div>
            		</div>
            	</li>
			@endforeach
