            ...
            <a href="/" class="m-index-icon"><i class="m-public-icon"></i></a>
                    ...
                    <section id="gallery" class="hotimg">
                        <ul class="slides" style="width: 600%; transition-duration: 0.4s; transform: translate3d(-828px, 0px, 0px);">
                            @foreach($data['goods_imgs'] as $k=>$v)
                                @if($k==0||$k==(count($data['goods_imgs'])-1))
                                    <li style="width: 414px; float: left; display: block;" class="clone">
                                        <a href="{{url('goodsLogo\\')}}{{$v}}">
                                            <img src="{{url('goodsLogo\\')}}{{$v}}" alt="">
                                        </a>
                                    </li>
                                @elseif($k==(ceil((count($data['goods_imgs'])-1)/2)))
                ...
                <div class="pro_info">
                    <h2 class="gray6">
                        ...
                        (第<em id='Period'>{{$data['goods_id']}}</em>潮)
                        {{$data['goods_name']}} {{$data['goods_desc']}}</span>
                    </h2>
                    ...
                    <div class="clearfix">
                        ...
                        <div class="gRate">
                            <div class="Progress-bar">
                                <p class="u-progress" title="已完成{{$num}}%">
                                    <span class="pgbar" style="width:{{$num}}%;">
                                        <span class="pging"></span>
                                    </span>
                                </p>
                                <ul class="Pro-bar-li">
                                    <li class="P-bar01"><em>{{$cart_num}}</em>已参与</li>
                                    <li class="P-bar02"><em>{{$data['goods_num']}}</em>总需人次</li>
                                    <li class="P-bar03"><em>{{$data['goods_num']-$cart_num}}</em>剩余</li>
                                </ul>
                            </div>
                        </div>
                    </div>
