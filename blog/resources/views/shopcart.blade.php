        ...
        <div class="g-Cart-list">
            <ul id="cartBody">
                ...
                <li>
                    ...
                    <div class="u-Cart-r">
                        <a href="/v44/product/12501977.do" class="gray6">(已更新至第{{$v->goods_id}}潮){{$v->goods_name}}（Bear）{{$v->goods_desc}}</a>
                        <span class="gray9">
                            <em>剩余{{$v->goods_num-$v->buy_number}}人次</em>
                        </span>
                        <div class="num-opt">
                    ...
                    @foreach($goods_data as $v)
                        <li>
                            <a href="https://m.1yyg.com/v44/products/23458.do" class="g-pic">
                                <img src="{{url('goodsLogo\\')}}{{$v->goods_img}}" width="136" height="136">
                            </a>
                            <p class="g-name">
                                <a href="https://m.1yyg.com/v44/products/23458.do">(第<i>{{$v->goods_id}}</i>潮){{$v->goods_name}}{{$v->goods_desc}}</a>
                            </p>
